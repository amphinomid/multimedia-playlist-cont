...
.to('.summer-songs', {
    motionPath: {
        path: [ {x: -5130 + document.documentElement.clientWidth, y: 0} ]
    },
    duration: 13,
    ease: 'power3.inOut'
})
...
.to('.icantbreathe-her-lyrics', { color: "#FFFFFF", duration: 0.25 }, '6')
.to('.pporappippam-sunmi-lyrics1', { color: "#FFFFFF", duration: 0.25 }, '6')
.to('.pporappippam-sunmi-lyrics2', { color: "#FFFFFF", duration: 0.25}, '6')
.to('.freesomebody-luna-lyrics', { color: "#FFFFFF", duration: 0.25}, '6')
...
//.to('.summer-7', { opacity: 0, duration: 2 }, '14')
...
.to('.autumn-songs', {
    motionPath: {
        path: [ {x: -4790 + document.documentElement.clientWidth + 100, y: 0} ]
    },
    duration: 13,
    ease: 'power3.inOut'
})
...
.to('.miseducation-laurynhill-comments1', { color: "#FFFFFF", duration: 0.25 }, '6')
.to('.miseducation-laurynhill-comments2', { color: "#FFFFFF", duration: 0.25 }, '6')
.to('.inseoul-epikhigh-lyrics', { color: "#FFFFFF", duration: 0.25 }, '6')
...
//.to('.autumn-7', { opacity: 0, duration: 2 }, '14')
